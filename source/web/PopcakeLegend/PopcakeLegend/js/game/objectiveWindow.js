...
DailyBunosWindow.prototype.Load = function () {
    this._uimanager = new UIManager();

    this.image = new ImageObject();
    if (this.type == 0) {
       this.image.Load("images/pop_ups/daily_bunos/board.png");
   } else if (this.type == 1) {
       this.image.Load("images/pop_ups/daily_bunos/board_life.png");
   }
...
DailyBunosWindow.prototype.Draw = function (gfx) {
    ...
    var stylearr = [
            "18pt Androgyne_TB",
            "Bold 36pt Androgyne_TB",
            "18pt Androgyne_TB",
    ];
    var yarr = [110, 180, 223];
    var ctx = gfx._canvasBufferContext;
