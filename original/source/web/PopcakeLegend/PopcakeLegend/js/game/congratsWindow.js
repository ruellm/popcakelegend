...
CongratsWindow.prototype.Load = function () {
   ...
   // this.image.Load("images/pop_ups/Popup-window.png");
    ...
    var imageArr = [
        "images/congrats/male-baker.png",
        "images/congrats/elephant.png",
        "images/congrats/squrrel.png",
        "images/congrats/female-baker.png"];
    ...
    var textImg = [
        "images/congrats/male-baker-txt.png",
        "images/congrats/elephant-txt.png",
        "images/congrats/squrrel-txt.png",
        "images/congrats/female-baker-txt.png"
    ];
...
CongratsWindow.prototype.Draw = function (gfx) {
    ...
    var basey = this._Y + 441;
    var x = this._X + 30;
    var xOffset =[0, 50, 2,0]; //first index points to second character
    var xOffsetBub = [20,40,10,-5];
    for (var i = 0; i < this.characters.length; i++) {
        ...
        if (this.displayText[i]) {
            this.textBubbles[i].Draw(gfx, x + xOffsetBub[i],
                characterY - this.textBubbles[i]._image.height);                
        }
