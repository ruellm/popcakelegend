...
var g_textMessageList = [
    ["This game really improves", "your memory? Maybe..."],
    ...
    ["This game trains your brain?", "Probably..."],
    ["Your brain is a muscle!", "This game is your coach!"],
    ["This game stimulates ","your brain? For sure!"],
    ["Improve your cognitive skills","with Professor Brain!"],
    ["The faster you play,","the higher you score!"],
    ["Use boosters... ","Boost your score!"],
    ["Well in your brain,", "well in your body!"],
    ["Play this game everyday,", "good brain forever? Not sure but it's fun!"],
...
LoadState.prototype.Load = function () {
    ...
    // Load the themes
	g_gameData.theme = THEME_TYPE_SAMPLE;
...
LoadState.prototype.LoadDatabaseInfo = function()
{
	...
	if(g_DBUserInfo) {
		...
		if(g_DBUserInfo.email != 0 && g_DBUserInfo.email !="" 
			&& g_DBUserInfo.email != "0") {
	...
	if(g_GeneralSettingsList){
		for(var i =0; i < g_GeneralSettingsList.length;i++){
			...
			} else if (data.name == "Free LIFE for Video") {
			    VIDEO_LIFE = data.value;
			}
		}
	}	
	...
	if( g_FriendsLevelMasterList){
		for(var i =0; i < g_FriendsLevelMasterList.length;i++){
			...
			if(player.fbid == g_DBUserInfo.fbid) continue;
...
LoadState.prototype.Draw = function (gfx) {
  ...
  // 	gfx.DrawImageFullA(this.images[1], 
   ...
   ////////////////////////////////////////////////////////
	...
	// the professor
	gfx.DrawImageFullA(this.images[8],
        750,
        115, 1.0);
		
	// the board
   	gfx.DrawImageFullA(this.images[7],
        (DEFAULT_WINDOW_WIDTH / 2) - (this.images[7].width / 2),
        220, 1.0);
   ...
   gfx.DrawImageFullA(this.images[3], 10, 303, 1.0);

   	gfx.DrawImageFullA(this.images[5], 
    ...
    if (barwidth) {
        gfx.DrawImage(this.images[6], 0, 0, barwidth, 48,
    ...
    //Grass
    gfx.DrawImageFullA(this.images[4], -30, 550, 1.0);
