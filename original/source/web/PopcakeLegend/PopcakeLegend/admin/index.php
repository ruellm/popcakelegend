<?php 
	...
	if($fbuid == 10153266381018604 /*Ruell Magpayo*/|| 
		$fbuid == 10153420899438604 /*drulztestapp-Ruell*/ ||
		$fbuid == 1474766226147767 /*Affan Shah*/ ||
		$fbuid == 10204298645481791 /*Fab Lejeux*/ ||
		$fbuid == 10153384570365127 /*Matt Vermeulen*/ ||
		$fbuid == 147888242222644 /* Mary Sharrow */) {
		$allowed = true;		
	}
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
     <head>
		...
		function UpdateGeneralSettings()
		{
			...
			{
				var r = confirm("This will Delete ALL USER and their Level data\n Continue?");
				if (r == true) {
	...
	<body>
		...
		<table>
			<tr>
				...
				<td><button type="button" onClick="Delete_ALL_USER()">Delete ALL USER records</button></td>
			</tr>
		</table>
