...
function FBAccess_AskLife(id)
{
	...
	FBAccess_SendAppRequest(id, "Your friend is asking for a life in PopcakeLegend", 
		function(to){
			Ajax_AskForLife(to);		
		});
}
...
{
    if (g_mainUser.id == -1) return;
        FBAccess_SendAppRequest(0, "Been having a good time playing PopcakeLegend, come check it out",
            function (to) {
